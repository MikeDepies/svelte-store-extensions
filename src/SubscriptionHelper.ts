...
import type { SubscribeFeature } from "./SubscribeFeature"
...
export function subscribeWithFeature<T>(store: Readable<T>, valueChange: (value: T) => void, feature: SubscribeFeature) {
